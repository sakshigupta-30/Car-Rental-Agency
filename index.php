...
<!-- Hero Section -->
<section class="hero-section text-center mt-3">
    <div class="container mt-4">
        <h1 class="display-4 fw-bold mb-3 hero-title">Find and Rent Cars Near You</h1>
        <p class="lead text-muted mb-4 hero-subtitle">A platform connecting customers with trusted rental agencies for<br>easy car bookings.</p>
    ...
    <div class="hero-image-container">
        <img src="assets/img/hero_car.jpg" alt="White Sports Car" class="img-fluid hero-car-img">
    </div>
</section>
            ...
            <div class="modal-body p-4">
                ...
                <form id="bookingForm">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <button type="submit" class="btn btn-dark w-100 rounded-pill custom-btn-dark py-2">Confirm
                            Booking</button>
                    <?php else: ?>
                        <div class="alert alert-warning text-center">
                            You must be logged in to book a car.
                        </div>
                        <a href="login.php" class="btn btn-dark w-100 rounded-pill custom-btn-dark py-2">Login to
                            Continue</a>
                    <?php endif; ?>
                </form>
            </div>
            ...
            <div class="col car-item" data-model="${car.model.toLowerCase()}" data-number="${car.vehicle_number.toLowerCase()}">
                <div class="card h-100 shadow-sm border-0 car-card">
                    ...
                    <div class="card-body">
                        ...
                        ${userRole !== 'agency' ? `<button onclick="handleRentClick(${car.id})" class="btn btn-dark rounded-pill w-100">Rent Car</button>` : ''}
                    </div>
                </div>
            </div>
            `;
